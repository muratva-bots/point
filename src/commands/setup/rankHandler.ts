...
import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, Interaction, Message, ModalBuilder, RoleSelectMenuBuilder, StringSelectMenuBuilder, TextInputBuilder, TextInputStyle, bold, inlineCode, roleMention } from "discord.js";
        ...
        if (i.isButton() && i.customId === "add") {
            ...
            if (roleCollected) {
                ...
                if (extraRoleCollected) {
                    const extraRole = extraRoleCollected.isStringSelectMenu() ? extraRoleCollected.values[0] : undefined;
